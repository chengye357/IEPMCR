...
class CaseEncoder_e2e_proto_mlp(BaseModel):
    def __init__(self,corpus,config):
        super(CaseEncoder_e2e_proto_mlp, self).__init__(config)             
...
#         d_keys = data_feed.keys()
        ...
        d_keys_int64 = ['curr_rsp_tokenid', 'curr_ctx_tokenid', 'caseid', 'curr_rsps_teach_tokenid', 'curr_rsps_target_tokenid', 'sim_rsp_tokenid', 'sim_ctx_tokenid']
